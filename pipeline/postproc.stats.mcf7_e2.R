...
# load predictions
preds.hmm = read.table("../peaks/hg19.mcf7_e2.new_hmm2b.bed", skip = 1)
preds.post2 = read.table("../peaks/hg19.mcf7_e2.new_hmm2b.post2.bed")
...
pdf("../peaks/sup.s1.panelC.mcf7_e2.pdf", width=14, height = 3)
